export default {
	...
	부산광역시: {
		중구: ['광복동', '남포동', '대청동', '동광동', '보수동', '부평동', '영주동1동', '영주동2동', '중앙동'],
		서구: [
			'남부민동1동',
			'남부민동2동',
			'동대신동1동',
		...
		강서구: ['가덕도동', '가락동', '강동동', '녹산동', '대저동1동', '대저동2동', '명지동1동', '명지동2동'],
		연제구: [
			'거제동1동',
			'거제동2동',
			'거제동3동',
		...
		수영구: ['광안동1동', '광안동2동', '광안동3동', '광안동4동', '남천동1동', '남천동2동', '망미동1동', '망미동2동', '민락동', '수영동'],
		사상구: [
			'감전동',
			'괘법동',
			'덕포동1동',
	...
	경기도: {
		...
		군포시: ['군포1동', '군포2동', '산본1동', '산본2동', '금정동', '재궁동', '오금동', '수리동', '궁내동', '대야동', '광정동', '송부동'],
		하남시: [
			'천현동',
			'신장1동',
			'신장2동',
		...
		여주시: ['가남읍', '점동면', '흥천면', '금사면', '세종대왕면', '대신면', '북내면', '강천면', '산북면', '여흥동', '중앙동', '오학동'],
	...
	강원도: {
		...
		영월군: ['영월읍', '상동읍', '산솔면', '김삿갓면', '북면', '남면', '한반도면', '한반도면쌍용출장소', '주천면', '무릉도원면'],
		평창군: ['평창읍', '미탄면', '방림면', '방림면계촌출장소', '대화면', '봉평면', '용평면', '진부면', '대관령면'],
		정선군: ['정선읍', '고한읍', '사북읍', '신동읍', '신동읍함백출장소', '남면', '북평면', '임계면', '화암면', '여량면'],
		철원군: ['철원읍', '김화읍', '갈말읍', '동송읍', '서면', '서면와수출장소', '근남면', '근북면', '근동면', '원동면', '원남면', '임남면'],
		화천군: ['화천읍', '간동면', '하남면', '상서면', '사내면'],
		양구군: ['양구읍', '국토정중앙면', '동면', '방산면', '해안면'],
		인제군: ['인제읍', '인제읍귀둔출장소', '남면', '북면', '기린면', '서화면', '상남면'],
	...
	충청북도: {
		...
		증평군: ['증평읍', '도안면'],
		진천군: ['진천읍', '덕산읍', '덕산읍혁신도시출장소', '초평면', '문백면', '백곡면', '이월면', '광혜원면'],
	...
	전라남도: {
		...
		광양시: ['광양읍', '봉강면', '옥룡면', '옥곡면', '진상면', '진월면', '다압면', '골약동', '중마동', '광영동', '금호동', '태인동'],
		...
		무안군: ['무안읍', '일로읍', '삼향읍', '삼향읍남악출장소', '몽탄면', '청계면', '현경면', '망운면', '해제면', '운남면'],
		...
		진도군: ['진도읍', '군내면', '고군면', '의신면', '임회면', '지산면', '조도면', '조도면가사출장소', '조도면거차출장소'],
		신안군: [
			'지도읍',
			'지도읍선도출장소',
			'압해읍',
	...
	경상북도: {
		...
		울진군: ['울진읍', '평해읍', '북면', '북면하당출장소', '근남면', '기성면', '온정면', '죽변면', '후포면', '금강송면', '매화면'],
		울릉군: ['울릉읍', '서면', '서면태하출장소', '북면'],
	},
	경상남도: {
		창원시: [
			'동읍',
