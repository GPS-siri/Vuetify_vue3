								...
								<v-flex xs9 v-if="left.type === 'time_range'" class="item_content_border px-2 table_right_white">
									<v-flex xs12 align-self-center wrap class="display_flex pt-3">
										...
										<v-flex xs5 align-self-center class="display_flex">
											...
											<selectBoxStyle :sel="left.selectBox_unit" @change="change()"></selectBoxStyle>
										</v-flex>
									</v-flex>
								</v-flex>
								...
								<v-flex xs9 v-if="left.type === 'radio_select'" class="item_content_border px-2 table_right_white">
									<div class="display_flex pt-3">
										<v-radio-group
											...
											hide-details
											row
											class="small_radio_admin mt-0 pt-0"
											style="width:100%;"
										>
										...
										<selectBoxStyle class="pl-10" :sel="left.selectBox" @change="change()"></selectBoxStyle>
									</div>
								</v-flex>
		...
		async system(id) {
			...
			await this.$store
				...
				.then(res => {
					...
					this.left_items[5].radios.radioSelected = '1'
