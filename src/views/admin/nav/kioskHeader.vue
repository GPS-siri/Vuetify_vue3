<template>
	<div style="width:100%; height:60px; background-color:#fff;">
		<v-layout justify-end align-center style="margin-right:37px">
			<v-flex md3 sm5 xs12 style="max-width:none">
...
export default {
	...
	async created() {
		// if (!this.$cookies.get('xi-t')) {
		// this.$router.push({ name: 'adminLogin' }).catch(() => {})
