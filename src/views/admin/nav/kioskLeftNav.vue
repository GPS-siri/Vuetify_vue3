	...
	<div class="leftNav_wrap">
		...
		<v-layout class="logoLayout" style="">
			<v-img
				...
				@click="$router.push({ name: 'dashBoard' }).catch(() => {}), ($store.state.drawer = false)"
				:src="$store.state.logoUrl"
				lazy-src="/image/logo_transparent.png"
			></v-img>
			<v-layout
				v-else
				justify-center
			...
			>
				<v-layout justify-center>
					<v-img contain max-width="115.6" max-height="30" src="/image/logo@2x.png"></v-img>
				</v-layout>
			</v-layout>
		</v-layout>
